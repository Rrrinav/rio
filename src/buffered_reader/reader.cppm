...
namespace rio {
    ...
    namespace detail {
        ...
        struct Storage_policy
        {
            ...
            std::uint8_t *start() noexcept { return reinterpret_cast<std::uint8_t *>(data_); }
        ...
        struct Storage_policy<0>
        {
            ...
            std::uint8_t *start() noexcept { return data_.data(); }
        ...
        inline bool is_stopper(unsigned char c) { return std::isspace(c) || c == '\0' || c == ','; }
    ...
    export struct String_source
    {
        ...
        static String_source from(std::string s) { return {std::move(s), 0}; }
    };
...
public:
    ...
    [[nodiscard]] size_type remaining() const noexcept { return valid_bytes_ - cursor_; }
